...
FORBIDDEN = (
    ...
    ("crew", ("uninstall",),
     "uninstall deletes the mailbox, the CLI and this guard itself"),
    ("crew", ("watch",), "opening a watcher pane is the foreman's to do"),
    ("crew", ("watchdog",), "one watchdog, started by the human or the foreman"),
    ("crew", ("log",), "the foreman digests the mailbox into the project log"),
